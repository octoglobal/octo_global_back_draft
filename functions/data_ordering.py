...
def get_status_of_package(status_id):
    statuses = {
        0: "Сконсолидировано пользователем",
        1: "Сконсолидировано администратором",
        2: "Присвоен адрес отправления, ждет отправки",
        3: "Отправлено, имеет трек номер",
        4: "Отклонено администратором",
    }
    status = statuses[status_id]
    return status
